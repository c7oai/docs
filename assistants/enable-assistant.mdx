---
title: 'Enable AI Assistant on your Website'
description: Step-by-step instructions how to embed and configure the Crescendo.ai AI Assistant on a Website
icon: 'code'
---

To enable Crescendo.ai AI Assistant on your WebSite, we provide Bot Widget that can be quickly added to your site.
...
| suppress-startup-form | Suppresses the startup data collection form. Shown later on handoff if required. Default: `false`.  |
